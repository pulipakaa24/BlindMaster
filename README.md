...
- **Account Management Screens** — [account_screen.dart](https://github.com/pulipakaa24/blinds_flutter/blob/main/lib/BlindMasterScreens/accountManagement/account_screen.dart), [change_email_screen.dart](https://github.com/pulipakaa24/blinds_flutter/blob/main/lib/BlindMasterScreens/accountManagement/change_email_screen.dart), [change_password_screen.dart](https://github.com/pulipakaa24/blinds_flutter/blob/main/lib/BlindMasterScreens/accountManagement/change_password_screen.dart), [verify_email_change_screen.dart](https://github.com/pulipakaa24/blinds_flutter/blob/main/lib/BlindMasterScreens/accountManagement/verify_email_change_screen.dart).
- **Network Layer** ([secure_transmissions.dart](https://github.com/pulipakaa24/blinds_flutter/blob/main/lib/BlindMasterResources/secure_transmissions.dart)) — Centralized HTTP helpers (`secureGet`, `securePost`, `secureDelete`, `regularGet`, `regularPost`) and a `connectSocket()` function. All secure calls attach JWTs from secure storage. Built-in retry-on-429 logic. Production server: `https://wahwa.com`; local dev toggle available.
